...
//his file is for managing app dashboard with most of the options of the app
                ...
                children: [
                  ListTile(
                    ...
                    trailing: ElevatedButton.icon(
                      onPressed: () {},
                      icon: ImageIcon(
                        const AssetImage(chatIcon),
                        color: kDarkGreenColor,
                      ),
                      label: CustomizedTextWidget(
                        textValue: AppConstants.assistant,
                        style: TextStyle(
                            color: kDarkGreenColor, fontWeight: FontWeight.bold),
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomizedTextWidget(
                            textValue: AppConstants.totalTax,
                            style: TextStyle(fontSize:fontSize*0.4, color: kSubtitleTextColor,),
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  CustomizedTextWidget(
                                    textValue: AppConstants.credits,
                                    style: TextStyle(
                                        fontSize: fontSize*0.4, color: kSubtitleTextColor),
                                  ),
                                  CustomizedTextWidget(
                              ...
                              IconButton(
                                  ...
                                  onPressed: () {},
                                  icon: const ImageIcon(AssetImage(penIcon),
                              ...
                              TextButton(
                                ...
                                child: CustomizedTextWidget(
                                  textValue: AppConstants.taxStats,
                      ...
                      children: [
                        Expanded(
                          child: SummaryCard(
                            ...
                            amount: '${AppConstants.currency} 38 576,90',
                    ...
                    Row(
                      ...
                      children: [
                        const CustomizedTextWidget(
                          textValue: AppConstants.actions,
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return const ActionList(
                                actionName: 'Action name',
                                actionDate: 'Income 12 Dec',
                                price: "${AppConstants.currency} 9,32",
                                totalPrice: "${AppConstants.currency} 9,32",
                                status: 'incoming');
                          }),
                    )
                  ],
